import DistanceInput from "../components/partner/DistanceInput";
import PartnerList from "../components/partner/PartnerList";
import React, { Component } from "react";
import GetPartner from "../components/accessData/GetPartner.js";
...
class NearMePage extends Component {
  constructor(props) {
    super(props);
    this.state = { distanceInput: "Distance", partners: [] };
    this.GetPartnersData = this.GetPartnersData.bind(this);
  }

  GetPartnersData(distance) {
    console.log(this.state.distanceInput + " " + distance);
    this.state.partners = GetPartner();
  ...
  render() {
    return (
      <section>
        <h1>Near Me</h1>
        <DistanceInput getPartners={this.GetPartnersData} />
